  ...
  return (
    <footer className="bg-navy text-ivory border-t border-gold">
      <div className="mx-auto max-w-7xl px-6 py-16 text-center">
        <div className="font-monument text-3xl tracking-[0.22em]">MINERVAE</div>
        ...
        <p className="mx-auto mt-8 max-w-2xl text-lg leading-8 text-ivory/80">
          MINERVAE is conceived as a permanent editorial house for the restoration of intellectual discipline and civilizational confidence in Western public life.
        </p>
